...
var setTotalTimeInPlayerBar(filterTimeCode(currentSongFromAlbum.length));
...
//___________________________________________BEGIN Williams code
...
var togglePlayFromPlayerBar = function() {
  ...
  if (currentSoundFile.isPaused()) {
    ...
    //_____________BEGIN change current song play-pause icon

    $songButtonContainer = $(".album-view-song-item").find("[data-song-number='" + currentlyPlayingSongNumber + "']");
    $songButtonContainer.html(playButtonTemplate);

    //______________END change current song play-pause icon

    currentSoundFile.pause();
  }
};

//__________________________________________END Williams code
